...
import type { PregledInPorocilaProps } from '@/../../product/sections/pregled-in-porocila/types'
...
import { Download, Filter, Users, TrendingUp, AlertCircle, FileText, Clock } from 'lucide-react'
                ...
                {filteredMemberObligations.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="px-4 py-8 text-center text-slate-500 dark:text-slate-400">
                      Ni obveznosti, ki bi ustrezale filtrom.
                    </td>
                  </tr>
                ) : (
